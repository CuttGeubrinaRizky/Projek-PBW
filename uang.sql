...
--
-- Host: 127.0.0.1
-- Generation Time: May 07, 2020 at 08:04 AM
...
(1, '2020_05_01_043139_create_pemasukans_table', 1),
(2, '2020_05_02_021621_create_users_table', 1),
(3, '2020_05_02_040603_create_pengeluarans_table', 1);
...
CREATE TABLE `pengeluarans` (
  ...
  `tanggal` date NOT NULL,
  `nominal` int(11) NOT NULL,
  `kategori2` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `keterangan` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
